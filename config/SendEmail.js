  ...
  <div class="email-container">
    ...
    <div class="content">
      <div class="lead-info">
        ...
        <div class="lead-row">
          <div class="lead-label">Stream</div>
          <div class="lead-value">${data?.stream}</div>
        </div>
      </div>

      <div class="marketing-section">
        <h3 class="section-title">Marketing Information</h3>
        ...
        <div class="lead-row">
          <div class="lead-label">Source URL</div>
          <a class="lead-value" href=${data?.sourceUrl}>Click here</a>
        </div>

        <div class="lead-row">
          <div class="lead-label">UTM Keyword</div>
          <div class="lead-value">${data?.utm_keyword}</div>
        </div>

        <div class="lead-row">
          <div class="lead-label">UTM Campaign</div>
